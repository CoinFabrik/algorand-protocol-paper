...
\begin{subsection}{Recovery Attempt}
    ...
    \begin{algorithm}[H]
        ...
        \For{$Account \ a \in A$}
            ...
            \If{$cred_j > 0$}
                \If{$\exists v=Proposal_{value}(e) $ for some $e\in P | \mathsf{IsCommitable}(v)$}
...
\begin{algorithm}[H]
    ...
    \If{$val \neq \bot \land \mathsf{Proposal}(v) \in P$}
        \State $\mathsf{Broadcast}(\mathsf{Proposal}(v))$
    \EndIf
