    ...
    \Function{$BlockProposal$}{$Block$ $B$, $Accounts$ $A$}
        ...
        \For{$a \in A$}
            ...
            \If{$j > 0$}
                ...
                \State $\mathsf{GOSSIP\_MSG}(a.pk, \mathsf{Signed}_{a.sk}(priority, \langle sorthash, \pi\rangle))$
            \EndIf
        \EndFor\
...
The $\mathsf{get}_{SKu}(ctx, round)$ helper function gets the relevant user's secret key \marginpar{User? O account $a$?}
