...
\begin{itemize}
    ...
    a 64-bits integer. When the round starts, $p$ is set to 0 ($p=0$), and it is increased
    with a logic we follow to explain.
    ...
    and it is increased with a logic we follow to explain (see (\ref{table:s})).
...
% equivocation vote
Let $I$ be an address, $r, s, p\in\Z_{\ge 0}$, $cred$ a credential, and $v_0,v_1$ different
vote proposals.
