...
% block assembly
Next, the $\mathsf{BlockProposal}$ algorithm runs (Algorithm~\ref{algo:block-proposal})
runs. It will ignore the resynchronization attempt call and move directly to the 
...
it will run the $\mathsf{Sortition}$ algorithm (Algo.~\ref{algo:sortition}) which basically
