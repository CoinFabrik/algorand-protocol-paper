...
and such that the sum of its weights ($\sum_{vt\in V} vt.cred.j\ge CommitteeThreshold(soft)$) 
...
for a value $v$ and of a proposal $e = Proposal(v)$ implies it that the associated entry committed.
