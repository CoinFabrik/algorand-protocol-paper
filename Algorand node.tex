...
% ---------------------------------------------------------------------------------------
\author{Argimiro del Pozzo\and Ariel Waissbein}
\date{CoinFabrik\\
\today}
\title{Algorand Protocol Description//[Draft]}
...
queries about the ledger.\marginpar{sabemos algo de como funciona esto??}
