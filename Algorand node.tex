...
\begin{itemize}
    ...
    votes may be added, and the set emptied.
    ...
    $\mathsf{BT}$ is the current balance table \index{balance table} that includes 
      ...
      in case the account is online and voting, it also includes
        ...
        and a set of public sub-batch ephemeral keys (and the first and last valid round for each key).
        ...
        This mapping makes all historical information accessible. Implementations usually cache certain past
    ...
    It supports
      ...
      an $\mathsf{iterator}(\cdot)$ helper function to construct, return an iterator into the queue, and 
    ...
    invalidated by round advancement.
